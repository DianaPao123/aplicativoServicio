                                                ...
                                                foreach (ComprobanteConcepto con in com.Conceptos)
                                                {
                                                    ...
                                                    */
                                                    ...
                                                    if (con.Impuestos != null && con.Impuestos.Retenciones != null)
                                                    {
                                                     ...
                                                     /// se agrego para quitar iva de retenciones 6%
                                                            if ((con.ClaveProdServ == "80111701" || con.ClaveProdServ == "80111700" || con.ClaveProdServ == "80110000" || con.ClaveProdServ == "80000000")
                                                                && (reten.Impuesto == "002" && reten.TipoFactor == "Tasa" && reten.TasaOCuota == 0.06M))
                                                            {
                                                                result = "CFDI33 - El valor del campo TasaOCuota que corresponde a Retención no contiene un valor del catálogo c_TasaOcuota para esta ClaveProdServ.";
                                                                return result;
                                                            }
                                                    ...
                                                    if (con.Parte != null)
                                                    {
                                                        ...
                                                        for (int j = 0; j < parte2.Length; j++)
                                                        {
                                                           ...
                                                           // Enum.TryParse<ServicioLocal.catCFDI.c_ClaveProdServ>(parte.ClaveProdServ, out myTipoClaveProdServ2);
                                                            ...
                                                            CatalogosSAT.c_ClaveProdServ CPS2 = oP.Consultar_ClaveProdServ(Convert.ToInt64(parte.ClaveProdServ));
                                                            if (CPS2 == null)
