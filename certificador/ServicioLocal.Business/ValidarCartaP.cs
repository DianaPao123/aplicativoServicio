    ...
    public class ValidarCartaP : NtLinkBusiness
    {
        ...
        public string ProcesarCarta(CartaPorte carta, Comprobante com)
        {
            try
            {
                ...
                string SS= valiadandoUbicaciones(carta, com.Emisor.Rfc, com.Receptor.Rfc, com.TipoDeComprobante);
                if (SS != "0")
                    return SS;
                //--------------------------------------------------------------------------------
               ...
               //     return "CP167 - El atributo \"Mercancias:PesoBrutoTotal\" no debe existir.";
                ...
                //----------mercancias------------------------------------------
                string SSS= validandoMercancia(carta, com.TipoDeComprobante);
                if (SSS != "0")
                    return SSS;
                //fin mercancias-------------------------
                ...
                if (carta.FiguraTransporte.Operadores != null)
                    {
                        string S = validandoOperadores(carta);
                        if (S != "0")
                            return S;
                ...
                //inicio propietario-------------------------------------------------
                     if (carta.FiguraTransporte!=null)
                      if (carta.FiguraTransporte.Propietario != null)
                       {
                           string S = validandoPropietario(carta, com.Emisor.Rfc, com.TipoDeComprobante);
                           if (S != "0")
                               return S;
                ...
                if (carta.FiguraTransporte.Arrendatario != null)
                       {
                           string S = validandoArrendatario(carta, com.Emisor.Rfc, com.TipoDeComprobante);
                            if (S != "0")
                              return S;
                         }// fin arrendatario-----------------------------------
              ...
              //inicio notificado--------------------------------------
                if (carta.FiguraTransporte!=null)
                       ...
                       {                         
                          string S= validandoNotificado(carta);
                          if (S != "0")
                              return S;
                       } //fin notificado
                //--------------------------------
        ...
        //************************************************************************************
        private string validandoMercancia(CartaPorte carta ,string TipoDeComprobante)
        {   try
            {
                ...
                foreach (var mer in carta.Mercancias.Mercancia)
                {
                    ...
                    if (!string.IsNullOrEmpty(mer.Cantidad))
                    {
                        ...
                        if (mer.BienesTranspSpecified == false)// modificado por mala interpretacion  
                            return "CP176 - El atributo \"BienesTransp\" contiene un valor o el tipo de comprobante es diferente de \"I\".";
                    ...
                    if (carta.TranspInternac == CartaPorteTranspInternac.Sí && mer.FraccionArancelariaSpecified == false)
                    ...
                    if (carta.TranspInternac == CartaPorteTranspInternac.No && mer.FraccionArancelariaSpecified == true)
                        return "CP185 - El atributo \"Mercancia:FraccionArancelaria\" tiene una clave diferente a las establecidas en el catálogo \"catComExt:c_FraccionArancelaria\" o este atributo no debe existir.";

                    if (carta.TranspInternac == CartaPorteTranspInternac.Sí && mer.FraccionArancelariaSpecified == true)
                    {
        ...
        //****************************************************************************************
        private string valiadandoUbicaciones(CartaPorte carta,string RFCEmisor,string RFCReceptor,string TipoDeComprobante)
        {   try
            {
                foreach (var ubi in carta.Ubicaciones)
                {
                    ...
                    if (ubi.Origen != null)
                    {
                        if (!string.IsNullOrEmpty(ubi.Origen.RFCRemitente))
                            if (ubi.Origen.RFCRemitente != RFCEmisor && TipoDeComprobante == "T")
                            {
                                Operaciones_IRFC r = new Operaciones_IRFC();
                        ...
                        if (!string.IsNullOrEmpty(ubi.Origen.RFCRemitente))
                            if (ubi.Origen.RFCRemitente != RFCReceptor  && TipoDeComprobante == "I")
                            {
                                Operaciones_IRFC r = new Operaciones_IRFC();
                                vI_RFC t = r.Consultar_IRFC(ubi.Origen.RFCRemitente);
                                if (t == null)
                        ...
                        if (ubi.Origen.RFCRemitente != RFCReceptor)
                        ...
                        if (carta.Mercancias.TransporteMaritimo != null || carta.Mercancias.TransporteAereo != null || carta.Mercancias.TransporteFerroviario != null)
                        {
                            ...
                            CatalogosSAT.c_Estaciones Esta = o1.Consultar_Estaciones(clavetrasp, ubi.Origen.NumEstacion);
                            if (Esta == null)
                            {
                    ...
                    if (ubi.Destino != null)
                    {
                        ...
                        if (!string.IsNullOrEmpty(ubi.Destino.RFCDestinatario))
                            if (ubi.Destino.RFCDestinatario != RFCEmisor && TipoDeComprobante == "T")
                            {
                                Operaciones_IRFC r = new Operaciones_IRFC();
                        ...
                        if (!string.IsNullOrEmpty(ubi.Destino.RFCDestinatario))
                            if (ubi.Destino.RFCDestinatario != RFCReceptor && TipoDeComprobante == "I")
                            {
                                Operaciones_IRFC r = new Operaciones_IRFC();
                                vI_RFC t = r.Consultar_IRFC(ubi.Destino.RFCDestinatario);
                                if (t == null)
        ...
        //****************************************************************************************
        private string validandoOperadores(CartaPorte carta)
        {
            try
            {
        ...
        //******************************************************************************************
        private string validandoPropietario(CartaPorte carta,string RFCEmisor,string TipoDeComprobante)
        {
            try
            {
                foreach (var pro in carta.FiguraTransporte.Propietario)
                {
                    ...
                    if (pro.RFCPropietario == RFCEmisor && TipoDeComprobante == "I")
        ...
        //*****************************************************************************************
        private string validandoArrendatario(CartaPorte carta,string RFCEmisor, string TipoDeComprobante)
        {
           try
           {
            foreach (var arr in carta.FiguraTransporte.Arrendatario)
            {
                ...
                if (arr.RFCArrendatario == RFCEmisor && TipoDeComprobante == "I")
        ...
        //******************************************************************************************
        private string validandoNotificado(CartaPorte carta)
        {
            try
            {
